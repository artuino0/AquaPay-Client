  ...
  return (
    <>
      {customers?.map((customer) => (
        <tr
          className="cursor-default border-b last:border-b-0 even:bg-gray-50 hover:bg-gray-100 text-sm"
          key={customer.id}
        >
          ...
          <td className="text-center">
            {customer.phoneNumber ? (
              <a href={`tel:+52${customer.phoneNumber}`}>
                {customer.phoneNumber}
              </a>
            ) : (
              "Sin registro"
          ...
          <td className="text-center">
            <Link
              ...
              to={`../customer/${customer.id}/services`}
            >
          ...
          <td className="text-center">
            {customer.createdBy?.name ? customer.createdBy?.name : "N/A"}
          </td>
          <td className="text-center flex justify-center items-center py-3 gap-6 text-base">
            <i
              ...
              onClick={() => handleCustomerSeletion(customer)}
            ></i>
